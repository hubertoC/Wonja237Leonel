...
use HZ\Wonja237Bundle\Entity\Actualite;
...
class ActualiteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $actualites = $em->getRepository('HZWonja237Bundle:Actualite')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('HZ\Wonja237Bundle\Form\ActualiteType', $actualite);
    ...
    {
        $deleteForm = $this->createDeleteForm($actualite);
        $editForm = $this->createForm('HZ\Wonja237Bundle\Form\ActualiteType', $actualite);
