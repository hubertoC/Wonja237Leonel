...
class ReservationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $reservations = $em->getRepository('HZWonja237Bundle:Reservation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('HZ\Wonja237Bundle\Form\ReservationType', $reservation);
    ...
    {
        $deleteForm = $this->createDeleteForm($reservation);
        $editForm = $this->createForm('HZ\Wonja237Bundle\Form\ReservationType', $reservation);
