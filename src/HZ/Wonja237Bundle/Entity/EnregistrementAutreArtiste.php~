...
/**
 * EnregistrementAutreArtiste
 *
 * @ORM\Table(name="EnregistrementAutreArtiste")
 * @ORM\Entity(repositoryClass="HZ\Wonja237Bundle\Repository\EnregistrementAutreArtisteRepository")
 */
class EnregistrementAutreArtiste
{
    /**
     * @var int
     *
     ...
     * @var string
     *
     * @ORM\Column(name="autreCategorie", type="string", length=255,  nullable=true)
     */
     ...
     * @var bool
     *
     * @ORM\Column(name="solo", type="boolean" , nullable=true)
     */
    private $solo;
