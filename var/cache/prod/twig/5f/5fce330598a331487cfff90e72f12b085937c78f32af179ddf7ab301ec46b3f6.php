...
class __TwigTemplate_2c16fb4288848fcb6c2a388507894f7197b5eb18e985e502947e21e7ae808456 extends Twig_Template
{
...
";
  ...
  <div class=\"row premierBlock \">
      ...
      <center>
        ...
        <center>
          <div class=\"\">
            ...
            ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "image", array()), 'widget', array("attr" => array("class" => "form-control-file")));
        echo "
          </div>
      </div>
    <div class=\"col-sm-8 \" style=\"background-color:#000;\">
      ...
      ";
        // line 50
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "name", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Nom")));
        echo "
      <br>
      ";
        // line 52
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "surname", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Prénom(s)")));
        echo "
    ...
    <div class=\"col-lg-6\">
      ...
      ";
        // line 57
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "number1", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Télephone 1")));
        echo "
    </div>
    <div class=\"offset-1 col-lg-6\">
      ...
      ";
        // line 61
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "number2", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Télephone 2")));
        echo "
    </div>
  </div>
  ...
  ";
        // line 66
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "email", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Email")));
        echo "

  <br>
  ";
        // line 69
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "ville", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Ville de résidence")));
        echo "
...
<div class=\"col-lg-6\">
  ...
  ";
        // line 75
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "groupe", array()), 'widget', array("attr" => array("class" => "form-check-input")));
        echo "
...
<div class=\"offset-1 col-lg-6\">
  ...
  ";
        // line 80
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "solo", array()), 'widget', array("attr" => array("class" => "form-check-input")));
        echo "
...
";
        // line 87
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "nomArtiste", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Nom(s) d'artiste")));
        echo "

<br>
";
        // line 90
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "categories", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Nom(s) d'artiste")));
        echo "

<br>
";
        // line 93
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "autreCategorie", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "Autre Categorie Precisez...")));
        echo "
<br>
";
        // line 95
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "sexe", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "")));
        echo "

<br>
";
        // line 98
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "style", array()), 'widget', array("attr" => array("class" => "form-control", "placeholder" => "")));
        echo "
<br>
    </div>
  </div>
...
<div class=\"row premierBlock\">
  ...
  <div class=\" offset-1 col-lg-12\">
    ...
    ";
        // line 110
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "description", array()), 'widget', array("attr" => array("class" => "form-control description")));
        echo "
    <br>
  </div>
...
<div class=\"offset-1 col-lg-12\">
  ";
        // line 119
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "link1", array()), 'widget', array("attr" => array("class" => "form-control offset-1 col-lg-6", "placeholder" => "Lien de audio ou des images")));
        echo "
<br>
</div>
...
<div class=\"offset-1 col-lg-12\">
  ";
        // line 124
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "link2", array()), 'widget', array("attr" => array("class" => "form-control offset-1 col-lg-6", "placeholder" => "Lien de la vidéo")));
        echo "
<br>
</div>
...
<div class=\"offset-1 col-lg-12\">
  ";
        // line 129
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "link3", array()), 'widget', array("attr" => array("class" => "form-control offset-1 col-lg-6", "placeholder" => "Lien facebook")));
        echo "
<br><br>
</div>
</div>
...
<div class=\"row premierBlock\">
  <div class=\"offset-1 col-lg-12\">
    ...
    ";
        // line 211
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "lu", array()), 'widget', array("attr" => array("class" => "form-check-input")));
        echo "
    ...
    ";
        // line 215
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute(($context["formAutre"] ?? null), "confirm", array()), 'widget', array("attr" => array("class" => "form-check-input")));
        echo "
...
";
    ...
    {
        return array (  345 => 226,  331 => 215,  324 => 211,  239 => 129,  231 => 124,  223 => 119,  211 => 110,  196 => 98,  190 => 95,  185 => 93,  179 => 90,  173 => 87,  163 => 80,  155 => 75,  146 => 69,  140 => 66,  132 => 61,  125 => 57,  117 => 52,  112 => 50,  104 => 45,  97 => 41,  88 => 35,  74 => 23,  70 => 21,  61 => 18,  53 => 12,  49 => 11,  46 => 10,  44 => 9,  40 => 8,  34 => 5,  31 => 4,  28 => 3,  11 => 1,);
    }
    ...
    {
        return new Twig_Source("", "HZWonja237Bundle:ArtistePublic:enregistremenArtiste.html.twig", "/homepages/2/d634677098/htdocs/wonja/src/HZ/Wonja237Bundle/Resources/views/ArtistePublic/enregistremenArtiste.html.twig");
    }
}
