...
class __TwigTemplate_e0c2ff4e805fc87db49ab6117a89d95a3713bc66611c03030b9a4d7f0f40222f extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["position"] => $context["e"]) {
            // line 40
            echo "    ";
            $this->loadTemplate("@Twig/Exception/traces.html.twig", "TwigBundle:Exception:exception.html.twig", 40)->display(array("exception" => $context["e"], "position" => $context["position"], "count" => ($context["previous_count"] ?? null)));
        }
        $_parent = $context['_parent'];
...
";
        ...
        <div id=\"logs\">
            ";
            // line 66
            $this->loadTemplate("@Twig/Exception/logs.html.twig", "TwigBundle:Exception:exception.html.twig", 66)->display(array("logs" => $this->getAttribute(($context["logger"] ?? null), "logs", array())));
            // line 67
            echo "        </div>
    </div>
";
...
";
        // line 91
        $this->loadTemplate("@Twig/Exception/traces_text.html.twig", "TwigBundle:Exception:exception.html.twig", 91)->display(array("exception" => ($context["exception"] ?? null)));
        // line 92
        echo "
...
";
    ...
    {
        return new Twig_Source("", "TwigBundle:Exception:exception.html.twig", "/homepages/2/d634677098/htdocs/wonja/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views/Exception/exception.html.twig");
    }
}
