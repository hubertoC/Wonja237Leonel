 ...
 */
class Video extends \HZ\Wonja237Bundle\Entity\Video implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\Video' . "\0" . 'id', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\Video' . "\0" . 'url', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\Video' . "\0" . 'alt'];
        }
