 ...
 */
class PubliciteDefile extends \HZ\Wonja237Bundle\Entity\PubliciteDefile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'id', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'name', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'facebook', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'instagram', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'twiter', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'description', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'link', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'url', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'alt', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'file', '' . "\0" . 'HZ\\Wonja237Bundle\\Entity\\PubliciteDefile' . "\0" . 'tempFilename'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PubliciteDefile $proxy) {
    ...
    public function setTwiter($twiter)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTwiter', [$twiter]);

        return parent::setTwiter($twiter);
    }
    ...
    public function getTwiter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTwiter', []);

        return parent::getTwiter();
    }
